...
weights = ''  # TODO: Change this path to the victim model's weights
...
root_dir = ''
mask_root_dir = ''
sub_folder_name = "ssd300_" + dataset + "_" + attack_strategy + "_" + moire_type_choice
...
for img in detection_img_names:
    ...
    # cv2.imwrite(save_dir+"/"+img, img_save_true, [int(cv2.IMWRITE_JPEG_QUALITY), 100])
...
print("attack finished, generate JSON files and calculate mAP")
