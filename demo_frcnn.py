...
attack_strategy = 'fabrication' # vanishing / fabrication /mislabeling
...
clean_results_file = './results/clean_results_frcnn_ocuhuman_v_parallel.json'
attack_results_file = './results/attack_results_frcnn_ocuhuman_v_parallel.json'

moire_type_choice = 'curved_line_moire' # 'parallel_line_moire' 'rotated_line_moire' 'curved_line_moire' 'random_pattern'
...
root_dir = ''
mask_root_dir = ''
sub_folder_name = "frcnn_" + dataset + "_" + attack_strategy + "_" + moire_type_choice + "TV"
...
if dataset == 'ocuhuman':
    fpath = '/home/xyf/Desktop/moirefool/dataset/OCHuman/images'    # TODO: Change this path to the image to be attacked
    VAL_ANNOTATIONS = '/home/xyf/Desktop/moirefool/dataset/OCHuman/ochuman_coco_format_all_range_0.00_1.00.json'
else:
    fpath = '/home/xyf/Desktop/moirefool/dataset/coco2017/cocoperson/images/val2017'    # TODO: Change this path to the image to be attacked
    VAL_ANNOTATIONS = '/home/xyf/Desktop/moirefool/dataset/coco2017/cocoperson/annotations/instances_val2017.json'
...
for img in detection_img_names:
    ...
    # -----------------------------------------------------------------------
    clean_json_results = append_json_result(clean_json_results, detections_query, x_meta, input_img, file2id, img, cloth_masks, model_type)
    ...
    save_path = f"{save_dir}/detection_{img}.png"
    ...
    if attack_strategy == 'mislabeling':
        ...
        x_adv_mislabeling_ll = tog_mislabeling(victim=detector, x_query=x_query, target='ll', n_iter=n_iter, eps=eps, eps_iter=eps_iter, mask=fi_moire_mask)
    ...
    if len(attack_detections_query)!= 0:
        attack_json_results = append_json_result(attack_json_results, attack_detections_query, x_meta, input_img, file2id, img, cloth_masks,model_type)
