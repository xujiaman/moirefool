...
class SSDInputEncoder:
    ...
    def generate_anchor_boxes_for_layer(self,
        ...
        cy = np.linspace(offset_height * step_height, (offset_height + int(feature_map_size[0]) - 1) * step_height, int(feature_map_size[0]))
        cx = np.linspace(offset_width * step_width, (offset_width + int(feature_map_size[1]) - 1) * step_width, int(feature_map_size[1]))
